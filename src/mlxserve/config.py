...
class Settings(BaseSettings):
    ...
    # mlx_lm logits processor: >1.0 discourages repetition; can destabilize some quants — off by default.
    # Enable e.g. MLXSERVE_GENERATION_REPETITION_PENALTY=1.08 when needed.
